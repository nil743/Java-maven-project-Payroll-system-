package payroll;
	...
	public class project extends JFrame implements ActionListener {
	    ...
	    project(){
	        ...
	        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/icons/New.png")));
	        ...
	        t4.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.SHIFT_MASK));
	        ...
	        s1.setMnemonic('U');
	        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/icons/EditOpen.png")));
	        ...
	        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/icons/New.png")));
